...
#Q1 xbox and >7 score
new_df=df[(df["score"] >=7) & (df['platform'] == 'Xbox One')]


xbox_one = df['platform']=="Xbox One"

new_df=df[xbox_one]
review=new_df['score_phrase']
review.hist(bins=20,xrot=90)

playstation = df['platform']=="PlayStation 4"

new_df=df[playstation]
review=new_df['score_phrase']
review.hist(bins=20,xrot=90)
