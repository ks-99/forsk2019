...
df['ESTEEM1']=df['ESTEEM1'].fillna(round(df['ESTEEM1'].mean()))
df['VIOL1']=df['VIOL1'].fillna(round(df['VIOL1'].mean()))    
df['PASSIST']=df['PASSIST'].fillna(round(df['PASSIST'].mode()))       
df['DEVIANT1']=df['DEVIANT1'].fillna(round(df['DEVIANT1'].mean()))
df['SCHCONN1']=df['SCHCONN1'].fillna(round(df['SCHCONN1'].mean()))
df['GPA1']=df['GPA1'].fillna(round(df['GPA1'].mean()))
df['EXPEL1']=df['EXPEL1'].fillna(round(df['EXPEL1'].mode()))
df['FAMCONCT']=df['FAMCONCT'].fillna(round(df['FAMCONCT'].mean()))
df['PARACTV']=df['PARACTV'].fillna(round(df['PARACTV'].mean()))
df['PARPRES']=df['PARPRES'].fillna(round(df['PARPRES'].mean()))
